// ️⚠️ WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING ️️⚠️
//
// This file has been modified to remove `targetText` breadcrumps.
// Submitting text content of DOM nodes could lead to user data leakage.
// When updating this file, please ensure that no text content is
// submitted.
//
// ⚠️ WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING ⚠️
...
(function (window, old) {
  ...
  if (getSetting("autoNotify", true)) {
    ...
    process && process.on('unhandledRejection', function(exception) {
      var shouldNotify = getSetting("autoNotify", true);
